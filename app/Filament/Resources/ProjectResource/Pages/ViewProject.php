        ...
        return [
            ...
            Actions\ActionGroup::make([
                Actions\Action::make('edit')
                    ->label(trans('resources.project.overall_edit'))
...
//                                                })
                ...
                //                Actions\Action::make(trans('resources.project.change_investor'))
                //                    ->fillForm(fn (Project $record): array => [
                ...
                //                            ->formatStateUsing(fn ($record) => self::getTranslation($record?->investor->name))
                ...
                //                        ]);
                //                    }),
//                Actions\Action::make('change_capital')
//                    ->label(trans('resources.project.change_capital'))
//                    ->fillForm(fn (Project $record): array => [
//                        'projectVariants' => $record->projectVariants,
//                    ])
//                    ->form([
//                        Repeater::make('projectVariants')->schema([
//                            TextInput::make('currency_rate')
//                                ->label(trans('resources.project.finance.currency_rate'))
//                                ->default(0)
//                                ->mask(RawJs::make('$money($input)'))
...
//                    }),
                ...
                ->label(trans('resources.project.edit-action-label'))
                ->visible(fn () => (new ProjectPolicy())->update(auth()->user(), $this->getRecord()))
                ->button(),
        ];
    }
