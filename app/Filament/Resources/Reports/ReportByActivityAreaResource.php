...
class ReportByActivityAreaResource extends Resource
{
    use ReportsQuery;
    ...
    protected static $tableContent = 'reports.report-by-activity-area';
    ...
    {
        return [
            'index' => Pages\ListReportByActivityArea::route('/'),
        ];
    }
