...
class ListInvestorProjectActivities extends ListActivities
{
    ...
    {
        $this->fields = (new InvestorProjectResource)
            ->form($form)
            ->model($this->record)
        ...
        return $this->paginateTableQuery(
            $this->record->activities()
                ->orWhere(function (Builder $query) {
                    $query->where('parent_subject_type', InvestorProject::class)
