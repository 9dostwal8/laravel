...
class ListLetterActivities extends ListActivities
{
    use LangSwitcher, InteractsWithForms;
    ...
    {
        $this->fields = (new LetterResource)
            ->form($form)
            ->model($this->record)
        ...
        return $this->paginateTableQuery(
            $this->record->activities()
                ->orWhere(function (Builder $query) {
                    $query->where('parent_subject_type', Letter::class)
