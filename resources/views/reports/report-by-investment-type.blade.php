@php
        $records = $records->groupBy('investment_type');
        $data = [];
        $grand_count = 0;
        ...
        foreach ($records as $investment_type => $projects) {
        ...
        foreach ($data as $investment_type => &$values) {
...
<div style="direction: rtl" dir="ltr"
    ...
    <table class="fi-ta-table w-full table-auto divide-y divide-gray-200 text-start dark:divide-white/5">
        ...
        <tr class="bg-gray-50 dark:bg-white/5">
            <th style="background-color: #ffca92" class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6">{{trans('resources.investment_type')}}</th>
        ...
        @foreach($data as $investment_type => $grand)
